...
table_id = 'PLM.Opportunity_temp'   # Temp table where records are extracted from MySQL
table_id2 = 'PLM.Opportunity'       # Final table where records are moved from Temp table
